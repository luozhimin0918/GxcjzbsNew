...
import com.jyh.gxcjzbs.view.BaseAnimatorSet;
...
public class MarketGridAdapter extends BaseListAdapter<NavIndextEntity.DataBean.ButtonBean> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            Glide.with(mContext).load(userBean.getImage()).error(R.mipmap.icon_default).placeholder(R.mipmap.icon_default).into
                    (mViewHolder.photoIv);
        } catch (Exception e) {
            e.printStackTrace();
            Glide.with(mContext).load(R.mipmap.icon_default).into(mViewHolder.photoIv);
        }
